		...
		var LightChartData = {
			...
			datasets : [
				{
					label: "Lux",
					fillColor : "rgba(240,221,116,0.2)",
					strokeColor : "rgba(240,221,116,1)",
					pointColor : "rgba(240,221,116,1)",
					pointStrokeColor : "#fff",
					pointHighlightFill : "#fff",
					pointHighlightStroke : "rgba(220,220,220,1)",
					data : []
        ...
        update3 = function(data){
			...
			index3 = index3 - 1;
                        LightChartData.datasets[0].data[10]= data;
			...
			for(var i = 10 ; i >= 0 ;i--)
			{
                LightChartData.datasets[0].data[10-i] = LightChartData.datasets[0].data[11-i];
			}
		}
        ...
        update4 = function(data){
			...
			for(var i = 10 ; i >= 0 ;i--)
			{
                AirChartData.datasets[0].data[10-i] = AirChartData.datasets[0].data[11-i];
			}
		}
